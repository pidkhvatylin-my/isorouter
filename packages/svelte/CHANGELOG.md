...
- Updated dependencies [[`af11d39`](https://github.com/pidkhvatylin-my/isorouter/commit/af11d39b3cfc530ce90594339cbeef27c30db7ff)]:
  - @isorouter/core@1.2.1
...
- Initial release. Svelte 5 adapter for `@isorouter/core`: `<Router>`,
  `<Outlet>`, `<Link>`, and `getRouter()`, built on `createSubscriber`.
